...
do
    ...
    while [  $COUNTER -lt 10 ]; do
        ...
        #no-ec
        java -jar runtest.jar data2.csv 7 res-no-ec.csv
        java -jar runtest.jar data4.csv 7 res-no-ec.csv
        java -jar runtest.jar data6.csv 7 res-no-ec.csv
        java -jar runtest.jar data8.csv 7 res-no-ec.csv
